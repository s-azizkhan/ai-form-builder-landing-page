        ...
        <footer className="px-4 py-16 bg-black border-t border-gray-800">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-6 retro-text text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500">
                  Don't Miss Out
                </h3>
                <p className="text-gray-300 mb-8">
                  Join our waitlist to be among the first to experience the future of form creation.
                </p>
                <WaitlistForm />
              </div>

              <div>
                <h3 className="text-2xl font-bold mb-6 retro-text text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">
                  Connect With Us
                </h3>
                <div className="flex space-x-4 mb-8">
                  ...
                  <Link
                    href="#"
                    className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-purple-500 transition-colors"
                  >
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <Link
                    href="#"
                    className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-cyan-500 transition-colors"
                  >
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path
                        fillRule="evenodd"
                ...
                <p className="text-gray-500 text-sm">© 2025 AI Form Builder. All rights reserved.</p>
              </div>
            </div>
          </div>
        </footer>
